                 ...
                 <div class="card-body">
                  ...
                  <form method="post" action = "{{ route('contactinfo.sent') }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" placeholder="Mail Sent Title" name = "email" value = "{{ $contactinfo->email }}">
                    </div>

                    <div class="form-group">
                      <label> Subject </label>
                      <input type="text" class="form-control" value = "{{ $contactinfo->subject }}">
                    </div>

                    <div class="form-group">
                      <label>Message </label>
                      <input type="text" class="form-control" value = "{{ $contactinfo->message }}">
                    </div>
